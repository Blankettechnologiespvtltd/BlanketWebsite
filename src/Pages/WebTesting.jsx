...
const WebTesting = () => {
  return (
    <div className="bg-gray-50 min-h-screen mt-[5rem]">
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            ...
            ensure that every release is secure, stable, and high-performing. We follow global
            testing standards while tailoring solutions to your unique business needs.
          </p>

          <ul className="space-y-3 text-gray-700">
            <li className="flex items-center">
              <ShieldCheck className="text-cyan-700 mr-2" /> Experienced QA Engineers
            </li>
            <li className="flex items-center">
              <Bug className="text-cyan-700 mr-2" /> Zero-Bug Delivery Approach
            </li>
            <li className="flex items-center">
              <Cpu className="text-cyan-700 mr-2" /> Automation + Manual Hybrid Testing
            </li>
            <li className="flex items-center">
              <Globe className="text-cyan-700 mr-2" /> Pan-India QA Coverage
            </li>
            <li className="flex items-center">
              <BarChart3 className="text-cyan-700 mr-2" /> Transparent Reporting System
            </li>
          </ul>
        </motion.div>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-cyan-700 to-blue-800 text-white py-16 text-center px-6">
        <motion.h3
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <p className="text-lg max-w-2xl mx-auto mb-6">
          ...
          From manual testing to full automation frameworks — our Pan India team ensures quality and performance at every stage.
        </p>
        <a
          href="/contact"

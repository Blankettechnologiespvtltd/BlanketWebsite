...
const Careers = () => {
  return (
    // <section className=" bg-blue-50 py-20 -mt-[5rem]  ">
    //   {/* Hero Section */}
    ...
    //   >
    //     <h1 className="text-5xl font-bold text-blue-700 mb-14 mt-30">
    ...
    <section className=" py-20  text-gray-800 ">
      ...
      <div className="max-w-6xl mx-auto mb-20 px-6 grid md:grid-cols-2 gap-10 items-center">
        <motion.img
          ...
          src="/career.jpg"
          alt="Our Culture"
          className="rounded-2xl shadow-lg object-cover w-full h-[18rem]"
        />
        <motion.div
          initial={{ opacity: 0, x: 40 }}
          whileInView={{ opacity: 1, x: 0 }}

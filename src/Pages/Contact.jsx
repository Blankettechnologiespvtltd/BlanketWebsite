  ...
  return (
    ...
    <section className="bg-gray-50 py-20 mt-[5rem] ">
      ...
      <motion.div
        ...
        className="text-center px-6 -mt-40 h-[26rem] pt-24 bg-gradient-to-b from-[#1B3C73] to-purple-400"
      >
        ...
        <motion.h1
                          ...
                          whileInView={{ opacity: 1, y: 0 }}
                          transition={{ duration: 0.6 }}
                          className="text-4xl md:text-5xl font-bold mb-6 text-white mt-28 md:mt-8"
                        >
                        Get in Touch with Blanket Technologies
                        </motion.h1>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 px-6  mt-15 mb-20">
        {[
          {
